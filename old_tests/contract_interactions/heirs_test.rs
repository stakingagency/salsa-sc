    ...
    SalsaContractObjBuilder: 'static + Copy + Fn() -> salsa::ContractObj<DebugApi>,
{
    ...
    pub fn undelegate_heir_test(
        ...
        self.blockchain_wrapper
            .execute_tx(heir, &self.salsa_wrapper, &big_zero, |sc| {
                sc.undelegate_heir(managed_address!(user), to_managed_biguint(amount), OptionalValue::Some(false))
            })
            .assert_ok();
    }
    ...
    pub fn undelegate_now_heir_test(
        ...
        self.blockchain_wrapper
            .execute_tx(heir, &self.salsa_wrapper, &big_zero, |sc| {
                sc.undelegate_now_heir(managed_address!(user), to_managed_biguint(min_amount), to_managed_biguint(amount), OptionalValue::Some(false))
            })
            .assert_ok();
    }
    ...
    pub fn remove_reserve_heir_test(
        ...
        self.blockchain_wrapper
            .execute_tx(heir, &self.salsa_wrapper, &big_zero, |sc| {
                sc.remove_reserve_heir(managed_address!(user), to_managed_biguint(amount), OptionalValue::Some(false))
            })
            .assert_ok();
    }
}
