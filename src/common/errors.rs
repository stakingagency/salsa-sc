...
pub static ERROR_PROVIDER_ALREADY_ADDED: &[u8] = b"Provider address already added";
pub static ERROR_PROVIDERS_NOT_SET: &[u8] = b"Providers not set";
pub static ERROR_PROVIDER_NOT_FOUND: &[u8] = b"Provider not found";
pub static ERROR_PROVIDER_NOT_UP_TO_DATE: &[u8] = b"Provider not up to date";
pub static ERROR_PROVIDER_WITH_FUNDS: &[u8] = b"SALSA still has funds in this provider";
...
pub static ERROR_WRONG_INHERITANCE_EPOCHS: &[u8] = b"Inheritance should be between 1 and 10 years";
